...
| 2.24 | Photo ±8% / video ±3% wall lengths | `benchmark/BENCHMARK_REPORT.md` | Photo median **20.7%**, video 38.3%, **0 of 6 passing**. A single passing dimension was traded for a fivefold gain in size correlation (+0.10 → +0.50) — the pass was chance under an estimator that barely tracked room size | **NOT DONE** — measured and reported |
