...
| 1b | **Xcode 16.4 cannot deploy to the paired iPhone (iOS 26.3.1).** Device support in this Xcode stops at 16.4; the phone is two major versions ahead. | Cannot install or debug on device at all | **OPEN — update to Xcode 26.x** |
